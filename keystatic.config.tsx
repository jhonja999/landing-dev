...
export default config({
	...
	// create a Keystatic Cloud account here: https://keystatic.cloud/
	cloud: {
		project: 'landing-dev/landing-dev',
	  },
	ui: {
		brand: { name: "landing-dev" },
	},
	...
	collections: {
			...
			schema: {
				...
				icon: fields.select({
					...
					options: [
						...
						{ label: "Buymeacoffee", value: "buymeacoffee" },
		...
		// nueva colección va dentro del objeto "collections" existente
		projects: collection({
			label: "Proyectos",
			...
			schema: {
				...
				image: fields.image({
					label: "Project Image",
					directory: "src/data/projects", // Directorio base para las imágenes
					publicPath: "./",
					validation: {
					  isRequired: true,
					},
